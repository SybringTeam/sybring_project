...
{
    /// <inheritdoc />
    public partial class ManyToManyProps : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedUserId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlexiTime = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MoreTime = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AttendanceTime = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    LeaveOfAbsence = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Childcare = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Overtime = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    InconvenientHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusUser", x => new { x.StatusId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_StatusUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StatusUser_Status_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeHistoryUser", x => new { x.TimeId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTimeReport", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectTimeReport_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectUsers", x => new { x.ProjectIdId, x.UsersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTimeReport_ProjectId",
